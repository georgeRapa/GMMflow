This is a pytorch implementation of GMMflow, the algorithm from our recent work [**Go With the Flow: Fast Diffusion for Gaussian Mixture Models**](https://arxiv.org/abs/2412.09059)
...
Instead of relying on neural networks and expensive training schemes, **GMMflow** proposes a closed form parametrization of the SDE drift to maps an intial GMM to a terminal one. 
